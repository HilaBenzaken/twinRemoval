...
public class GrapgView extends ApplicationFrame {
	...
	public GrapgView(String title, String categoryAxesLabel, String valueAxeslabel) {
		super(title);
		dataset = createDataset();
		final JFreeChart chart = createChart(dataset, title, categoryAxesLabel, valueAxeslabel);
		final ChartPanel chartPanel = new ChartPanel(chart);
		chartPanel.setPreferredSize(new Dimension(500, 270));
		setContentPane(chartPanel);
	}

	private JFreeChart createChart(final CategoryDataset dataset, String title, String categoryAxesLabel, String valueAxeslabel) {
